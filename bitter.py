...
<div class="panel panel-default">
    ...
    <div class="list-group-item">
      <h4 style="color: inherit;">
        <a role="button" class="list-group-item-heading" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
  ...
  <div class="panel panel-default">
    <div class="list-group">
    <div class="list-group-item">
    <div class="list-group-item-heading" role="tab" id="headingTwo">
  ...
  <div class="panel panel-default">
    <div class="list-group">
    <div class="list-group-item">
        <div class="list-group-item-heading" role="tab" id="headingThree">
          <h4 class="panel-title">
